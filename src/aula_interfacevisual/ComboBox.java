...
public class ComboBox extends javax.swing.JFrame {
    ...
    private void jbuttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonSalvarActionPerformed
        if(txfNovoProduto.getText().isEmpty()){
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if(txfProdutoSelecionado.getText().isEmpty()){
           JOptionPane.showMessageDialog(null,"Ocorreu um erro durante a remoção!\nRemoção negada.","Erro",JOptionPane.ERROR_MESSAGE);
           return;
        }
        try {
            String produtoSelecionado = jcbProdutos.getSelectedItem().toString();
            jcbProdutos.removeItem(produtoSelecionado);
            txfProdutoSelecionado.setText("");
